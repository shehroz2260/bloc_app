...
class MapBloc extends Bloc<MapEvent, MapState> {
  ...
  MapBloc()
      : super(MapState(
            address: "",
            googlePlex: const CameraPosition(target: LatLng(0, 0)),
            isLoading: false,
            markers: {},
            resultList: [],
            selectedUser: UserModel.emptyModel,
            showWidget: false)) {
...
//////////////////////////////////////////////  ///////////////////////////////////////////////////////////////
  ...
  Future<void> createPlacesMarker(
      UserModel user, BuildContext context, Emitter<MapState> emit) async {
  ...
  _onTapMarker(OnTAPMarkerEvent event, Emitter<MapState> emit) {
    if (state.selectedUser.uid == event.user.uid) {
  ...
  Future<void> createMyMarker(double newLatitude, double newLongitude,
    ...
    bitData = await MarkerHelper().getAssetMarkerIcon(
        "assets/images/png/myLocation.png", const Size(122.0, 120.0));
