...
class CustomSigninBtnWithSocial extends StatelessWidget {
  ...
  const CustomSigninBtnWithSocial(
      {super.key, this.onTap, this.icon, this.isApple = false});
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: SvgPicture.asset(
            icon ?? (isApple ? AppAssets.appleIcon : AppAssets.googleIcon),
            height: 30,
            width: 30),
      ),
    );
...
class CustomBackButton extends StatelessWidget {
  ...
  const CustomBackButton({super.key, this.isUSerPRofile = false});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
          ...
          child:
              Icon(Icons.arrow_back_ios_outlined, color: AppColors.redColor)),
    );
  }
}
