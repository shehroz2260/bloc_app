...
class Go {
  ...
  await  Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (context)=> child), (val)=> false);
  }
  static Future<void> to(BuildContext context, Widget child)async{
   ...
   await Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> child));
  }
