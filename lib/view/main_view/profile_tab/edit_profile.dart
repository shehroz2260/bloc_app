...
class _EditProfileState extends State<EditProfile> {
  ...
  void didChangeDependencies() {
   ancestorContext = MyInheritedWidget(bloc: context.read<EditBloc>(),child: const SizedBox()).bloc;
        ...
        body: Padding(
          ...
          child:  BlocBuilder<UserBaseBloc,UserBaseState>(
            builder: (context,userState) {
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text("Edit Profile",style: AppTextStyle.font25.copyWith(color: AppColors.blackColor)),
                         ...
                         builder: (context,state) {
                           return Column(
                             ...
                             children: [
                               Align(
                                alignment: Alignment.center,
                                 child: GestureDetector(
                                   onTap: () {
                                     context.read<EditBloc>().add(ImagesPick(context: context));
                                   },
                                   child: Stack(
                                     ...
                                     children: [
                                       Container(
                                         ...
                                         child: (state.imageFile?.path??"").isEmpty? AppCacheImage(imageUrl: context.read<UserBaseBloc>().state.userData.profileImage,round: 150,):
                                         ClipRRect(
                                       ...
                                       Container(
                                         ...
                                         child: Icon(Icons.edit,color: AppColors.redColor),
                                       )
                                     ],
                                   ),
                                 ),
                               ...
                               const AppHeight(height: 30),
                                        Text("First Name:",style: AppTextStyle.font20.copyWith(color: AppColors.blackColor),
                                        
                                        ),
                                       const AppHeight(height: 5),
                                        CustomTextField(hintText: "Enter first name",textEditingController: _nameController,
                                            validator: AppValidation.nameValidation,                                    //  enabled: state.isEdit,
                                        ),
                                       const AppHeight(height: 20),
                                       Text("Bio:",style: AppTextStyle.font20.copyWith(color: AppColors.blackColor),),
                                       const AppHeight(height: 5),
                                        CustomTextField(hintText: "EnTer bio",textEditingController: _bioController,
                                            validator: AppValidation.bioValidation,                                    //  enabled: state.isEdit,
                                        
                                        ),
                                       const AppHeight(height: 20),
                                       Text("About:",style: AppTextStyle.font20.copyWith(color: AppColors.blackColor),),
                                       const AppHeight(height: 5),
                                        CustomTextField(hintText: "Enter About",textEditingController: _aboutController,maxLines: 4,
                 ...
                 GestureDetector(
                  ...
                  onTap: () {
                   ...
                   child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text("Gender",style: AppTextStyle.font20.copyWith(
                        color: AppColors.blackColor
                      )),
                      Text( "Edit",style: AppTextStyle.font16.copyWith(
                        color: AppColors.redColor
                      ),),
                    ],
                   ),
                 ...
                 const AppHeight(height: 5),
                 Text(userState.userData.gender == 1? "Male":"Female",style: AppTextStyle.font20.copyWith(
                      color: AppColors.redColor
                    ),),
                 Container(
                   ...
                   GestureDetector(
                    ...
                    behavior: HitTestBehavior.opaque,
                     child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                       children: [
                         Text("Interested",style: AppTextStyle.font20.copyWith(
                            color: AppColors.blackColor
                          )),
                         Text("Edit",style: AppTextStyle.font16.copyWith(
                            color: AppColors.redColor
                 ...
                 const AppHeight(height: 20),
                  GridView.builder(
                       ...
                       gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,crossAxisSpacing: 10,mainAxisSpacing: 10,childAspectRatio: 3.3),itemCount: userState.userData.myInstrest.length, itemBuilder: (context,index){
                       final interest = userState.userData.myInstrest[index];
                       return Container(
              ...
              const AppHeight(height: 20),
               CustomNewButton(btnName: "Update",onTap: () {
                if(!_formKey.currentState!.validate())return;
                 context.read<EditBloc>().add(UpdateUser(context: context, firstName: _nameController.text, bio: _bioController.text, about: _aboutController.text));
               }),
              const AppHeight(height: 20)
                ],
              );
